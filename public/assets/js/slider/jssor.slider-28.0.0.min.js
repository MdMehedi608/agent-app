...
!(function (i, h, m, e, d, k, f) {
    ...
    var t = (i.$JssorCaptionSlideo$ = function () {
        ...
        j = (i.$JssorSlider$ = (i.module || {}).exports = function () {
            ...
            function MakeCustomSlider(Index) {
                //alert(Index);
                Index1 = Index + 1;
                console.log(Index1);
                        ...
                        success: function (Responsedata) {
                            ...
                            if (Responsedata.length == "1") {
                                for (var i = 0; i < Responsedata.length; i++) {
                                    var BCBookAccessCode1 = Responsedata[i].secondaryBannerAccessCode1;
                                    var BCBookAccessCode2 = Responsedata[i].secondaryBannerAccessCode2;

                                    var BookName1 = Responsedata[i].secondaryBannerAccessCode3;
                                    var BookName2 = Responsedata[i].secondaryBannerAccessCode4;

                                    //console.log(BookName1 + "|" + BookName2);
                                    //alert(BCBookAccessCode1 + "|" + BCBookAccessCode2 + "|" + BookName1 + "|" + BookName2);

                                    var StrRandomNumber = Math.random();

                                    if (!!BCBookAccessCode1 && BCBookAccessCode1 != "" && !!BCBookAccessCode2 && BCBookAccessCode2 != "" && !!BookName1 && BookName1 != "" && !!BookName2 && BookName2 != "") {
                                        var image1 = $("#ImgSecondaryBanner1");
                                        var imageURL1 = "https://www.panjeree.org/DIR/Com/PBS/Product/Image/" + Responsedata[i].secondaryBannerAccessCode1 + ".jpg?id=" + StrRandomNumber;

                                        image1.animate({ 'left': '-1000' }, 'fast', function () { image.css({ 'left': '1000px' }); });
                                        image1.attr('src', imageURL1);
                                        image1.animate({ 'left': '0' }, 'fast');

                                        $('#aImgSecondaryBanner1').attr("href", '/book/' + BCBookAccessCode1 + "/" + BookName1.toLowerCase());
                                        //--------------------------------//
                                        var image2 = $("#ImgSecondaryBanner2");
                                        var imageURL2 = "https://www.panjeree.org/DIR/Com/PBS/Product/Image/" + Responsedata[i].secondaryBannerAccessCode2 + ".jpg?id=" + StrRandomNumber;
                                        //alert(imageURL2);

                                        image2.animate({ 'left': '-1000' }, 'fast', function () { image.css({ 'left': '1000px' }); });
                                        image2.attr('src', imageURL2);
                                        image2.animate({ 'left': '0' }, 'fast');

                                        $('#aImgSecondaryBanner2').attr("href", '/book/' + BCBookAccessCode2 + "/" + BookName2.toLowerCase());

                                        //$('#ImgSecondaryBanner1').attr('src', Responsedata[i].secondaryBanner1);
                                        //$('#ImgSecondaryBanner2').attr('src', Responsedata[i].secondaryBanner2);
                                    }
                                    else {
                                        var image1 = $("#ImgSecondaryBanner1");
                                        var imageURL1 = "~/images/product/common/common_image.png";

                                        image1.animate({ 'left': '-1000' }, 'fast', function () { image.css({ 'left': '1000px' }); });
                                        image1.attr('src', imageURL1);
                                        image1.animate({ 'left': '0' }, 'fast');

                                        $('#aImgSecondaryBanner1').attr("href", '');
                                        //--------------------------------//
                                        var image2 = $("#ImgSecondaryBanner2");
                                        var imageURL2 = "~/images/product/common/common_image.png";

                                        image2.animate({ 'left': '-1000' }, 'fast', function () { image.css({ 'left': '1000px' }); });
                                        image2.attr('src', imageURL2);
                                        image2.animate({ 'left': '0' }, 'fast');

                                        $('#aImgSecondaryBanner2').attr("href", '');
                                    }
                                }
                            }
                            else {
