  ...
  return (
    <section>
        <div className="text-center min-height-container minimum_height">
            ...
            <p className="CartEmptyText1 text-center mt-5">Confirmation!!</p>
            <p className="CartEmptyText2 text-center">Your demand request has been successfully submitted</p>
